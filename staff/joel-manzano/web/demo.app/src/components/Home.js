...
function Home({ token, onLogout }) {
    ...
    return <div className="home">
        <nav className="home__header">
            ...
            {/* <a className={`home__menu-link ${view === 'order'? 'home__menu-link--active' :''}`} href="" onClick={goToOrder}>order</a> */}
        ...
        orderId={orderId}
            ...
            <Routes>
                ...
                <Route path="cart" element={<Cart token={token} onItem={goToDetails} />} />
