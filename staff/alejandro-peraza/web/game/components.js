...
function Roboloko(color, width, height) {
    ...
    const earRight = new Shape(color, width / 10, height / 5)
    earRight.moveRight(width)
    earRight.moveDown(height / 5)

    const earLeft = new Shape(color, width /10, height / 5)
    earLeft.moveLeft(width / 10) 
    earLeft.moveDown(height / 5)
